...
class Album_Select(discord.ui.Select):
    ...
    async def callback(self, itx: discord.Interaction):
        ...
        await discord.utils.get(itx.guild.channels,name="食堂").send("調査が終わりました")
        self.disabled=True
...
class Album(commands.Cog):#Cog名、頭大文字でクラス作成
    ...
    async def album(self,itx:discord.Interaction): 
        ...
        await itx.response.send_message(f"{itx.user.nick}が誰かの卒業アルバムを調べています、少々お待ちください")
